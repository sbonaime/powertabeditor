                                          ...
                                          int systemIndex)
{
    ...
    if (myViewOptions.getDrawStaffRectangleBool())
    {
        myParentSystem->setPen(QPen(myPalette.text(), 0.5));
    }
    else
    {
        // Draw an invisible rectangle around the staff
        QPen pen;  // creates a default pen
        pen.setColor(QColor( 0xFF, 0xA0, 0x00,0 ));
        myParentSystem->setPen(QPen(pen));
    }
